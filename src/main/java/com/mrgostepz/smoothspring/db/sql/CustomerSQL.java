...
import static com.mrgostepz.smoothspring.db.TableName.TABLE_CUSTOMER;

public class CustomerSQL {
    public static final String SQL_GET_ALL_CUSTOMER = "SELECT * FROM " + TABLE_CUSTOMER + ";";
    public static final String SQL_GET_CUSTOMER_BY_ID = "SELECT * FROM " + TABLE_CUSTOMER + " WHERE CUSTOMER_ID = ?;";
