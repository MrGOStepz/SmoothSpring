...
public class StaffSQL {
    ...
    public static final String SQL_ADD_STAFF = "INSERT INTO " + TABLE_STAFF + " (" + COL_FIRST_NAME + ", " + COL_LAST_NAME + ", " + COL_PHONE + ", " + COL_EMAIL + ", " + COL_STAFF_POSITION_ID + ", " +  COL_CLOCK_STATUS_ID + ", " + COL_PASSWORD + ", " + COL_IS_ACTIVE + ") VALUE(?,?,?,?,?,?,?,?);";
    public static final String SQL_UPDATE_STAFF = "UPDATE STAFF SET(" + COL_FIRST_NAME + " = ?, " + COL_LAST_NAME + " = ?, " + COL_PHONE + " = ?, " + COL_EMAIL + " = ?, " + COL_STAFF_POSITION_ID + " = ?, " +  COL_CLOCK_STATUS_ID + " = ?, " + COL_PASSWORD + " = ?, " + COL_IS_ACTIVE + " = ?) WHERE " + COL_STAFF_ID + " = ?;";
