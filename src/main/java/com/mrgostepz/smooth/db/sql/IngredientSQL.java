...
import static com.mrgostepz.smooth.db.ColumnName.COL_INGREDIENT_ID;
import static com.mrgostepz.smooth.db.ColumnName.COL_INGREDIENT_IMAGE_PATH;
import static com.mrgostepz.smooth.db.ColumnName.COL_INGREDIENT_NAME;
import static com.mrgostepz.smooth.db.TableName.TABLE_INGREDIENT;
...
public class IngredientSQL {
    ...
    public static final String SQL_GET_INGREDIENT_BY_COLUMN = "SELECT ? FROM " + TABLE_INGREDIENT + " WHERE ? = ?";
}
